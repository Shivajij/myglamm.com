      ...
      <Slider height="400px" {...settings} ref={(slider) => setSlider(slider)}>
        {carouselData.map((item, index) => (
          <RouteLink to="/product/makeup">
            <Box cursor={"pointer"} className="box" key={index}>
              <Box className="hoverProperty singleProduct">
                <Image className="productCarouselImage" src={item.image} />
                <Box
                  padding={"10px"}
                ...
                >
                  ...
                  <Box>
                    <Box>
                      <Text className="carouselSubtitle">{item.subtitle}</Text>
                    </Box>
                    <Flex justifyContent={"space-evenly"}>
                      ...
                      <Text className="carouselTotalRating">
